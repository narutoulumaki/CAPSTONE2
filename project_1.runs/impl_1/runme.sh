...
HD_PWD='c:/vivadocodes/vedicdivide/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vedicdivider_dhwajank_hybrid.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vedicdivider_dhwajank_hybrid.tcl -notrace
