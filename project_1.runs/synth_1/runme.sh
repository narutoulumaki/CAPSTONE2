...
HD_PWD='c:/vivadocodes/vedicdivide/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vedicdivider_dhwajank_hybrid.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vedicdivider_dhwajank_hybrid.tcl
